        ...
        switch (tag) {
            ...
            case MapFragment.TAG:
                ...
                if (eventBusMessage.getArg1() instanceof String) {
                    ...
                    bundle.putSerializable("arg1", (AlarmInfo) eventBusMessage.getArg1());
                }
            ...
            case DigitizingModifyFragment.TAG:
                transaction
                        .replace(R.id.second_framelayout, DigitizingModifyFragment.newInstance((DigitalizerBean)
                                eventBusMessage.getArg1()), tag).commit();
                if (!isActivity) {
                    transaction.addToBackStack(tag);
                }
            ...
            case SecondPublishFragment.TAG:
                transaction
                        .replace(R.id.second_framelayout, SecondPublishFragment.newInstance((ReqAddPlan)
                                eventBusMessage.getArg1()), tag).commit();
                if (!isActivity) {
                    transaction.addToBackStack(tag);
                }
            ...
            case ThirdPublishFragment.TAG:
                transaction
                        .replace(R.id.second_framelayout, ThirdPublishFragment.newInstance((ReqAddPlan)
                                eventBusMessage.getArg1()), tag).commit();
                if (!isActivity) {
                    transaction.addToBackStack(tag);
                }
            ...
            case TaskListFragment.TAG:
                transaction
                        .replace(R.id.second_framelayout, TaskListFragment.newInstance((PlanBean)
                                eventBusMessage.getArg1()), tag).commit();
                if (!isActivity) {
                    transaction.addToBackStack(tag);
                }
            ...
            case SignInFragment.TAG:
                transaction
                        .replace(R.id.second_framelayout, SignInFragment.newInstance((TaskSiteBean)
                                eventBusMessage.getArg1()), tag).commit();
                if (!isActivity) {
                    transaction.addToBackStack(tag);
                }
