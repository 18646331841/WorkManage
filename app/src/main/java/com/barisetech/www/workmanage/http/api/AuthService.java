...
public interface AuthService {
    ...
    Observable<BaseResponse<List<AuthInfo>>> getAll(@Body ReqAllAuth reqAllAuth);
    ...
    Observable<BaseResponse<String>> modify(@Path("token") String token, @Body ReqModifyAuth reqModifyAuth);
}
